#' @name ascentTraining-package
#' @title Ascent Training Datasets
#' @aliases ascentTraining ascentTraining-package
#' @description Datasets designed to be used in conjunction with Ascent training materials.
#' @docType package
#' @details 
#' Datasets designed to be used in conjunction with Ascent training materials and 
...
#' @author Ascent
#'
#' Contact: Ascent \email{rin24hours@@mango-solutions.com}
NULL
